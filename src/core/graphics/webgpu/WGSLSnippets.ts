...
/**
 * Simplex 3D noise for WGSL shaders.
 *
 * Includes helper functions: mod289_3, mod289_4, permute, taylorInvSqrt
 * Main function: simplex3D(v: vec3<f32>) -> f32
 *
