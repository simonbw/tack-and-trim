/**
 * Water surface fullscreen shader.
 *
 * Extends FullscreenShader base class for water/terrain surface rendering.
...
/**
 * Water surface fullscreen shader using the FullscreenShader base class.
 */
export class WaterSurfaceShader extends FullscreenShader<typeof bindings> {
